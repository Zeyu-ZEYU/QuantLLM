...
CODE_NAME_FOR_SHELL = "sp_transformer_infer_quant.py"
CODE_PATH_FOR_SHELL = "/home/hshen/zeyu/QuantLLM/quantization"


# Inference config
CONFIG = {}
CONFIG["param_path"] = "/home/hshen/zeyu/large_files/params.pkl"
CONFIG["tokenizer_path"] = "/home/hshen/zeyu/QuantLLM/quantization/tokenizer_kernel.pkl"
...
class DistributedModel(torch.nn.Module):
    ...
    def _execute_core(self, rank, is_master=False):
        ...
        model = Model(CONFIG["param_path"], f"cuda:{gpu_id}")
        # get START cmd
...
if __name__ == "__main__":
    ...
    if args.server:
        ...
        if args.worker:
            assert args.rank > 0
            dist_gpt_model = DistributedModel()
